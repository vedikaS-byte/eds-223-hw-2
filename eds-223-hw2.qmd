...
if (st_crs(birds) == st_crs(inequal)) {
  ...
  stop("CRS mismatch between birds and inequal: Double check transformations for matching CRS between spatial objects!")
}
...
grade_colors <- c("A" = "#76a865", # Best rank
                  "B" = "#7cb5bd",
                  "C" = "#ffff00",
                  "D" = "#d9838d") # Worst rank
...
![](figs/Percent%20of%20Bird%20Observations%20in%20Redlined%20Neighborhoods%20Within%20HOLC%20Grades.png)

***Figure 4. Finalized bar graph of percent bird observations made in
